...
/* Comment : Menambahkan aksi ketika button login diklik. */
loginFormElement.addEventListener('submit', function(event) {
  ...
  */
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Jika sudah sesuai maka program akan berpindah ke halaman home. */
    goToHome();
  } else {

    /* Comment : Jika tidak sesuai maka program akan menampilkan pop up informasi bahwa informasi login salah. */
    showPopUp();
  }
});
